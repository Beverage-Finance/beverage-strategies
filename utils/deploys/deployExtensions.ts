...
import { BeverageFeeSplitExtension__factory } from "../../typechain/factories/BeverageFeeSplitExtension__factory";
...
export default class DeployExtensions {
  ...
  public async deployBeverageFeeSplitExtension(
    manager: Address,
    streamingFeeModule: Address,
    debtIssuanceModule: Address,
    operatorFeeSplit: BigNumber,
    operatorFeeRecipient: Address
  ): Promise<BeverageFeeSplitExtension> {
    return await new BeverageFeeSplitExtension__factory(this._deployerSigner).deploy(
      manager,
      streamingFeeModule,
      debtIssuanceModule,
      operatorFeeSplit,
