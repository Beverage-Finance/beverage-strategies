...
import { AaveLeverageStrategyExtension, BeverageBaseManager, StandardTokenMock, WETH9, ChainlinkAggregatorV3Mock } from "@utils/contracts/index";
...
describe("LeverageStrategyExtension", () => {
  ...
  async function deployFLISetup(fliSettings: FLISettings): Promise<void> {
    ...
    // Transfer ownership to beverage manager contract
