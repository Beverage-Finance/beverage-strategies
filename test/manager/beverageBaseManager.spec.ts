...
import { BeverageBaseManager, BaseExtensionMock } from "@utils/contracts/index";
...
describe("BeverageBaseManager", () => {
  ...
  before(async () => {
    ...
    // Deploy BeverageBaseManager
    baseManager = await deployer.manager.deployBeverageBaseManager(
      owner.address,
      methodologist.address,
    );

    // Transfer ownership to BeverageBaseManager
  ...
  describe("#constructor", async () => {
    ...
    async function subject(): Promise<BeverageBaseManager> {
      return await deployer.manager.deployBeverageBaseManager(
        subjectOperator,
  ...
  describe("#setManager", async () => {
    ...
    async function subject(): Promise<any> {
      return baseManager.connect(subjectCaller.wallet).setManager(subjectSetToken, subjectNewManager);
    }
  ...
  describe("#addModule", async () => {
    ...
    async function subject(): Promise<any> {
      return baseManager.connect(subjectCaller.wallet).addModule(subjectSetToken, subjectModule);
    }
  ...
  describe("#removeModule", async () => {
    ...
    async function subject(): Promise<any> {
      return baseManager.connect(subjectCaller.wallet).removeModule(subjectSetToken, subjectModule);
    }
