...
import { ICManager, BaseManager, BaseManagerV2, BeverageBaseManager } from "../contracts/index";
...
import { BeverageBaseManager__factory } from "../../typechain/factories/BeverageBaseManager__factory";
...
export default class DeployToken {
  ...
  public async deployBeverageBaseManager(
    operator: Address,
    methodologist: Address
  ): Promise<BeverageBaseManager> {
    return await new BeverageBaseManager__factory(this._deployerSigner).deploy(
      operator,
      methodologist
    );
  }
